...
#define CHECKBOX_MARGIN 0  /* MAX SPAN -   CHECK -   MARGIN */
...
static config_widget page_general[] = {
    {TYPE_SELECT, SELECT_USER_DIRECTORY, TR_USER_DIRECTORIES_WINDOW_USER_PATH, display_text_user_directory, 0, 1, ITEM_BASE_H, 0, TR_USER_DIRECTORIES_WINDOW_USER_PATH_TOOLTIP},
    {TYPE_SELECT, SELECT_LANGUAGE, TR_CONFIG_LANGUAGE_LABEL, display_text_language, 0, 1, ITEM_BASE_H, 15, TR_CONFIG_LANGUAGE_LABEL_TOOLTIP},
    {TYPE_SELECT, SELECT_PLAYER_NAME, TR_CONFIG_DEFAULT_PLAYER_NAME, display_text_player_name, 0, 1, ITEM_BASE_H, 15},

    {TYPE_NUMERICAL_DESC, RANGE_GAME_SPEED, TR_CONFIG_GAME_SPEED, NULL, 0, 1, ITEM_BASE_H, 10, TR_CONFIG_GAME_SPEED_TOOLTIP},
    {TYPE_NUMERICAL_RANGE, RANGE_GAME_SPEED, 0, display_text_game_speed, 0, 1, ITEM_BASE_H, 2},

    {TYPE_NUMERICAL_DESC, RANGE_DEFAULT_GAME_SPEED, TR_CONFIG_DEFAULT_GAME_SPEED, NULL, 0, 1, ITEM_BASE_H, 10, TR_CONFIG_DEFAULT_GAME_SPEED_TOOLTIP},
    {TYPE_NUMERICAL_RANGE, RANGE_DEFAULT_GAME_SPEED, 0, display_text_default_game_speed, 0, 1, ITEM_BASE_H, 2},

    {TYPE_NUMERICAL_DESC, RANGE_MAX_AUTOSAVE_SLOTS, TR_CONFIG_MAX_AUTOSAVE_SLOTS, NULL, 0, 1, ITEM_BASE_H, 10, TR_CONFIG_MAX_AUTOSAVE_SLOTS_TOOLTIP},
    {TYPE_NUMERICAL_RANGE, RANGE_MAX_AUTOSAVE_SLOTS, 0, display_text_autosave_slots, 0, 1, ITEM_BASE_H, 2},
    {TYPE_CHECKBOX, CONFIG_GP_CH_YEARLY_AUTOSAVE, TR_BUTTON_YEARLY_AUTOSAVE_ON, NULL, 0, 1, ITEM_BASE_H, 10},

    //VIDEO
    {TYPE_HEADER, 0, TR_CONFIG_VIDEO, NULL, 0, 1, ITEM_BASE_H, 30},
    ...
    {TYPE_CHECKBOX, CONFIG_SCREEN_COLOR_CURSORS, TR_CONFIG_USE_COLOR_CURSORS, NULL, 0, 1, ITEM_BASE_H, 10},
    {TYPE_CHECKBOX, CONFIG_GENERAL_UNLOCK_MOUSE, TR_CONFIG_GENERAL_UNLOCK_MOUSE, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN},

    //AUDIO
    {TYPE_HEADER, 0, TR_CONFIG_AUDIO, NULL, 0, 1, ITEM_BASE_H, 30},

    {TYPE_CHECKBOX, CONFIG_GENERAL_ENABLE_AUDIO, TR_CONFIG_ENABLE_AUDIO, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN},
    {TYPE_NUMERICAL_RANGE, RANGE_MASTER_VOLUME, 0, display_text_master_volume, 0, 1, ITEM_BASE_H, 0},

    {TYPE_CHECKBOX, CONFIG_ORIGINAL_ENABLE_MUSIC, TR_CONFIG_MUSIC, NULL, 0, 1, ITEM_BASE_H, 20},
    {TYPE_CHECKBOX, CONFIG_GENERAL_ENABLE_MUSIC_RANDOMISE, TR_CONFIG_RANDOMISE_MUSIC, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_RANDOMISE_MUSIC_TOOLTIP},
    {TYPE_NUMERICAL_RANGE, RANGE_MUSIC_VOLUME, 0, display_text_music_volume, 0, 1, ITEM_BASE_H, 0},

    {TYPE_CHECKBOX, CONFIG_ORIGINAL_ENABLE_SPEECH, TR_CONFIG_SPEECH, NULL, 0, 1, ITEM_BASE_H, 20},
    {TYPE_NUMERICAL_RANGE, RANGE_SPEECH_VOLUME, 0, display_text_speech_volume, 0, 1, ITEM_BASE_H, 0},

    {TYPE_CHECKBOX, CONFIG_ORIGINAL_ENABLE_SOUND_EFFECTS, TR_CONFIG_EFFECTS, NULL, 0, 1, ITEM_BASE_H, 20},
    {TYPE_CHECKBOX, CONFIG_UI_MOVE_LEGION_SOUND_SWAP, TR_CONFIG_MOVE_LEGION_SOUND_SWAP, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_MOVE_LEGION_SOUND_SWAP_TOOLTIP},
    {TYPE_NUMERICAL_RANGE, RANGE_SOUND_EFFECTS_VOLUME, 0, display_text_sound_effects_volume, 0, 1, ITEM_BASE_H, 0},

    {TYPE_CHECKBOX, CONFIG_ORIGINAL_ENABLE_CITY_SOUNDS, TR_CONFIG_CITY_SOUNDS, NULL, 0, 1, ITEM_BASE_H, 20},
    {TYPE_NUMERICAL_RANGE, RANGE_CITY_SOUNDS_VOLUME, 0, display_text_city_sounds_volume, 0, 1, ITEM_BASE_H, 0},

    {TYPE_CHECKBOX, CONFIG_GENERAL_ENABLE_VIDEO_SOUND, TR_CONFIG_VIDEO_SOUND, NULL, 0, 1, ITEM_BASE_H, 20},
    {TYPE_NUMERICAL_RANGE, RANGE_VIDEO_VOLUME, 0, display_text_video_volume, 0, 1, ITEM_BASE_H, 0},

    {TYPE_SPACE, 0, 0, NULL, 0, 1, ITEM_BASE_H, 0}, //white space
    {TYPE_NONE}
};
...
static config_widget ui_widgets_by_category[CATEGORY_UI_COUNT][MAX_WIDGETS] = {
    // General
    {
        {TYPE_CHECKBOX, CONFIG_UI_SHOW_INTRO_VIDEO, TR_CONFIG_SHOW_INTRO_VIDEO, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_SHOW_INTRO_VIDEO_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_SIDEBAR_INFO, TR_CONFIG_SIDEBAR_INFO, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_SIDEBAR_INFO_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_ASK_CONFIRMATION_ON_FILE_OVERWRITE, TR_CONFIG_ASK_CONFIRMATION_ON_FILE_OVERWRITE, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_ASK_CONFIRMATION_ON_FILE_OVERWRITE_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_SHOW_MAX_PROSPERITY, TR_CONFIG_SHOW_MAX_POSSIBLE_PROSPERITY, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_SHOW_MAX_POSSIBLE_PROSPERITY_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_DIGIT_SEPARATOR, TR_CONFIG_DIGIT_SEPARATOR, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_DIGIT_SEPARATOR_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_MESSAGE_ALERTS, TR_CONFIG_UI_MESSAGE_ALERTS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_UI_MESSAGE_ALERTS_TOOLTIP},
        {TYPE_NONE}
    },
    // Scrolling
    {
        {TYPE_NUMERICAL_DESC, RANGE_SCROLL_SPEED, TR_CONFIG_SCROLL_SPEED, NULL, 0, 1, ITEM_BASE_H, -10},
        {TYPE_NUMERICAL_RANGE, RANGE_SCROLL_SPEED, 0, display_text_scroll_speed, 0, 1, ITEM_BASE_H, 0},
        {TYPE_CHECKBOX, CONFIG_UI_SMOOTH_SCROLLING, TR_CONFIG_SMOOTH_SCROLLING, NULL, 0, 1, ITEM_BASE_H, 10},
    ...
    // Building
    {
        {TYPE_CHECKBOX, CONFIG_UI_SHOW_MARKET_RANGE, TR_CONFIG_SHOW_MARKET_RANGE, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_SHOW_MARKET_RANGE_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_SHOW_CONSTRUCTION_SIZE, TR_CONFIG_SHOW_CONSTRUCTION_SIZE, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_SHOW_CONSTRUCTION_SIZE_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_ALWAYS_SHOW_ROTATION_BUTTONS, TR_CONFIG_UI_ALWAYS_SHOW_ROTATION_BUTTONS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_UI_ALWAYS_SHOW_ROTATION_BUTTONS_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_SHOW_GRID, TR_CONFIG_UI_SHOW_GRID, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_UI_SHOW_GRID_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_SHOW_PARTIAL_GRID_AROUND_CONSTRUCTION, TR_CONFIG_UI_SHOW_PARTIAL_GRID_AROUND_CONSTRUCTION, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_UI_SHOW_PARTIAL_GRID_AROUND_CONSTRUCTION_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_CLIMATE_GRID_COLORS, TR_CONFIG_UI_CLIMATE_GRID_COLORS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_UI_CLIMATE_GRID_COLORS_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_SHOW_ROAMING_PATH, TR_CONFIG_SHOW_ROAMING_PATH, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_SHOW_ROAMING_PATH_TOOLTIP},

        {TYPE_HEADER, 0, TR_CONFIG_HEADER_DESIRABILITY, NULL, 0, 1, ITEM_BASE_H, 14},
        {TYPE_CHECKBOX, CONFIG_UI_SHOW_DESIRABILITY_RANGE, TR_CONFIG_SHOW_DESIRABILITY_RANGE, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_SHOW_DESIRABILITY_RANGE_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_SHOW_DESIRABILITY_RANGE_ALL, TR_CONFIG_SHOW_DESIRABILITY_RANGE_ALL, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_SHOW_DESIRABILITY_RANGE_ALL_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_SHOW_SHORELINE_DESIRABILITY, TR_CONFIG_SHOW_SHORELINE_DESIRABILITY, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_SHOW_SHORELINE_DESIRABILITY_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_SHOW_ELEVATION_DESIRABILITY, TR_CONFIG_SHOW_ELEVATION_DESIRABILITY, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_SHOW_ELEVATION_DESIRABILITY_TOOLTIP},

        {TYPE_SPACE, 0, 0, NULL, 0, 1, ITEM_BASE_H, 0}, //white space
        {TYPE_CHECKBOX, CONFIG_UI_PAVED_ROADS_NEAR_GRANNARIES, TR_CONFIG_ENABLE_PAVED_ROADS_NEAR_GRANARIES, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_ENABLE_PAVED_ROADS_NEAR_GRANARIES_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_BUILD_SHOW_RESERVOIR_RANGES, TR_CONFIG_UI_BUILD_SHOW_RESERVOIR_RANGES, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_UI_BUILD_SHOW_RESERVOIR_RANGES_TOOLTIP},

        {TYPE_HEADER, 0, TR_CONFIG_HEADER_WATER_STRUCTURE_RANGE, NULL, 0, 1, ITEM_BASE_H, 14},
        {TYPE_CHECKBOX, CONFIG_UI_SHOW_WATER_STRUCTURE_RANGE, TR_CONFIG_SHOW_WATER_STRUCTURE_RANGE, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_SHOW_WATER_STRUCTURE_RANGE_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_SHOW_WATER_STRUCTURE_RANGE_HOUSES, TR_CONFIG_SHOW_WATER_STRUCTURE_RANGE_HOUSES, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_SHOW_WATER_STRUCTURE_RANGE_HOUSES_TOOLTIP},
    ...
    // CityView
    {
        {TYPE_CHECKBOX, CONFIG_UI_HIGHLIGHT_LEGIONS, TR_CONFIG_HIGHLIGHT_LEGIONS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_HIGHLIGHT_LEGIONS_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_SHOW_MILITARY_SIDEBAR, TR_CONFIG_SHOW_MILITARY_SIDEBAR, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_SHOW_MILITARY_SIDEBAR_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_HIGHLIGHT_SELECTED_BUILDING, TR_CONFIG_HIGHLIGHT_SELECTED_BUILDING, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_HIGHLIGHT_SELECTED_BUILDING_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_MOVE_SAVINGS_TO_RIGHT, TR_CONFIG_MOVE_SAVINGS_TO_THE_RIGHT, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_MOVE_SAVINGS_TO_THE_RIGHT_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_DRAW_ASCLEPIUS, TR_CONFIG_DRAW_ASCLEPIUS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_DRAW_ASCLEPIUS_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_SHOW_CUSTOM_VARIABLES, TR_CONFIG_SHOW_CUSTOM_VARIABLES, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_SHOW_CUSTOM_VARIABLES_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_CLEAR_WARNINGS_RIGHTCLICK, TR_CONFIG_CLEAR_WARNINGS_RIGHTCLICK, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_CLEAR_WARNINGS_RIGHTCLICK_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_CV_BUILD_MENU_ICONS, TR_CONFIG_UI_CV_BUILD_MENU_ICONS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_UI_CV_BUILD_MENU_ICONS_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_CV_CURSOR_SHADOW, TR_CONFIG_UI_CV_CURSOR_SHADOW, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_UI_CV_CURSOR_SHADOW_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_ENABLE_BUILD_MENU_SHORTCUTS, TR_CONFIG_ENABLE_BUILD_MENU_SHORTCUTS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_ENABLE_BUILD_MENU_SHORTCUTS_TOOLTIP},
        {TYPE_NONE}
    },
    // Weather
    {
        {TYPE_CHECKBOX, CONFIG_UI_DRAW_CLOUD_SHADOWS, TR_CONFIG_DRAW_CLOUD_SHADOWS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_DRAW_CLOUD_SHADOWS_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_UI_DRAW_WEATHER, TR_CONFIG_DRAW_WEATHER, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_DRAW_WEATHER_TOOLTIP},

        {TYPE_NUMERICAL_DESC, RANGE_WEATHER_DURATION, TR_CONFIG_WT_WEATHER_DURATION, NULL, 0, 1, ITEM_BASE_H, 0},
        {TYPE_NUMERICAL_RANGE, RANGE_WEATHER_DURATION, 0, display_text_weather_duration, 0, 1, ITEM_BASE_H, 2},

        //RAIN
        {TYPE_HEADER, 0, TR_CONFIG_HEADER_RAIN, NULL, 0, 1, ITEM_BASE_H, 20},
        ...
        {TYPE_NUMERICAL_DESC, RANGE_RAIN_INTENSITY, TR_CONFIG_WT_RAIN_INTENSITY, NULL, 0, 1, ITEM_BASE_H, 0},
        ...
        //SNOW
        {TYPE_HEADER, 0, TR_CONFIG_HEADER_SNOW, NULL, 0, 1, ITEM_BASE_H, 20},
        ...
        {TYPE_NUMERICAL_DESC, RANGE_SNOW_INTENSITY, TR_CONFIG_WT_SNOW_INTENSITY, NULL, 0, 1, ITEM_BASE_H, 0},
        ...
        //SAND
        {TYPE_HEADER, 0, TR_CONFIG_HEADER_SAND, NULL, 0, 1, ITEM_BASE_H, 20},

        {TYPE_CHECKBOX, CONFIG_UI_WT_PREVIEW_SANDSTORM, TR_CONFIG_UI_WT_PREVIEW_SANDSTORM, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN},
        {TYPE_NUMERICAL_DESC, RANGE_SANDSTORM_INTENSITY, TR_CONFIG_WT_SANDSTORM_INTENSITY, NULL, 0, 1, ITEM_BASE_H, 0},
    ...
    // Empire
    {
        {TYPE_CHECKBOX, CONFIG_UI_ANIMATE_TRADE_ROUTES, TR_CONFIG_UI_ANIMATE_TRADE_ROUTES, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_UI_ANIMATE_TRADE_ROUTES_TOOLTIP},
...
static config_widget page_difficulty[] = {
    {TYPE_NUMERICAL_DESC, RANGE_DIFFICULTY, TR_CONFIG_DIFFICULTY, NULL, 0, 1, ITEM_BASE_H, -20},
    {TYPE_NUMERICAL_RANGE, RANGE_DIFFICULTY, 0, display_text_difficulty, 0, 1, ITEM_BASE_H, -5},
    {TYPE_CHECKBOX, CONFIG_ORIGINAL_GODS_EFFECTS, TR_CONFIG_GODS_EFFECTS, NULL, 0, 1, ITEM_BASE_H, 10, TR_CONFIG_GODS_EFFECTS_TOOLTIP},
    {TYPE_CHECKBOX, CONFIG_GP_CH_JEALOUS_GODS, TR_CONFIG_JEALOUS_GODS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_JEALOUS_GODS_TOOLTIP},
    {TYPE_CHECKBOX, CONFIG_GP_CH_GLOBAL_LABOUR, TR_CONFIG_GLOBAL_LABOUR, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_GLOBAL_LABOUR_TOOLTIP},
    {TYPE_CHECKBOX, CONFIG_GP_CH_RETIRE_AT_60, TR_CONFIG_RETIRE_AT_60, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_RETIRE_AT_60_TOOLTIP},
    {TYPE_CHECKBOX, CONFIG_GP_CH_FIXED_WORKERS, TR_CONFIG_FIXED_WORKERS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_FIXED_WORKERS_TOOLTIP},
    {TYPE_CHECKBOX, CONFIG_GP_CH_WOLVES_BLOCK, TR_CONFIG_WOLVES_BLOCK, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_WOLVES_BLOCK_TOOLTIP},
    {TYPE_CHECKBOX, CONFIG_GP_CH_AUTO_KILL_ANIMALS, TR_CONFIG_AUTO_KILL_ANIMALS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_AUTO_KILL_ANIMALS_TOOLTIP},
    {TYPE_CHECKBOX, CONFIG_GP_CH_MULTIPLE_BARRACKS, TR_CONFIG_MULTIPLE_BARRACKS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_MULTIPLE_BARRACKS_TOOLTIP},
    {TYPE_CHECKBOX, CONFIG_GP_CH_RANDOM_COLLAPSES_TAKE_MONEY, TR_CONFIG_RANDOM_COLLAPSES_TAKE_MONEY, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_RANDOM_COLLAPSES_TAKE_MONEY_TOOLTIP},
    {TYPE_CHECKBOX, CONFIG_GP_CH_DISABLE_INFINITE_WOLVES_SPAWNING, TR_CONFIG_GP_CH_DISABLE_INFINITE_WOLVES_SPAWNING, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_GP_CH_DISABLE_INFINITE_WOLVES_SPAWNING_TOOLTIP},
    {TYPE_NUMERICAL_DESC, RANGE_MAX_GRAND_TEMPLES, TR_CONFIG_MAX_GRAND_TEMPLES, NULL, 0, 1, ITEM_BASE_H, 0, TR_CONFIG_MAX_GRAND_TEMPLES_TOOLTIP},
...
static config_widget city_mgmt_widgets_by_category[CATEGORY_CITY_COUNT][MAX_WIDGETS] = {
    // Storage
    {
        {TYPE_CHECKBOX, CONFIG_GP_CH_NO_SUPPLIER_DISTRIBUTION, TR_CONFIG_NO_SUPPLIER_DISTRIBUTION, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_NO_SUPPLIER_DISTRIBUTION_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_GP_CH_GRANARIES_GET_DOUBLE, TR_CONFIG_GRANARIES_GET_DOUBLE, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_GRANARIES_GET_DOUBLE_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_GP_CH_ALLOW_EXPORTING_FROM_GRANARIES, TR_CONFIG_ALLOW_EXPORTING_FROM_GRANARIES, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_ALLOW_EXPORTING_FROM_GRANARIES_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_GP_CH_FARMS_DELIVER_CLOSE, TR_CONFIG_FARMS_DELIVER_CLOSE, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_FARMS_DELIVER_CLOSE_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_GP_CH_WAREHOUSES_DONT_ACCEPT, TR_CONFIG_NOT_ACCEPTING_WAREHOUSES, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_NOT_ACCEPTING_WAREHOUSES_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_GP_CH_MARKETS_DONT_ACCEPT, TR_CONFIG_NOT_ACCEPTING_MARKETS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_NOT_ACCEPTING_MARKETS_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_GP_CH_DELIVER_ONLY_TO_ACCEPTING_GRANARIES, TR_CONFIG_DELIVER_ONLY_TO_ACCEPTING_GRANARIES, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_DELIVER_ONLY_TO_ACCEPTING_GRANARIES_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_GP_STORAGE_INCREMENT_4, TR_CONFIG_STORAGE_STEP_4, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_STORAGE_STEP_4_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_GP_CH_ENABLE_GETTING_WHILE_STOCKPILED, TR_CONFIG_ENABLE_GETTING_WHILE_STOCKPILED, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_ENABLE_GETTING_WHILE_STOCKPILED_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_GP_CH_CART_DEPOT_ADVANCED, TR_CONFIG_ADVANCED_CART_DEPOT_OPTIONS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_ADVANCED_CART_DEPOT_OPTIONS_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_GP_CH_STORAGE_REQUESTS_RESPECT_MAINTAIN, TR_CONFIG_GP_CH_STORAGE_REQUESTS_RESPECT_MAINTAIN, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_GP_CH_STORAGE_REQUESTS_RESPECT_MAINTAIN_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_GP_CH_MARKET_RANGE, TR_CONFIG_ENABLE_MARKET_RANGE, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_ENABLE_MARKET_RANGE_TOOLTIP},
        {TYPE_NONE}
    },
    // Roads
    {
        {TYPE_CHECKBOX, CONFIG_GP_CH_WAREHOUSES_GRANARIES_OVER_ROAD_PLACEMENT, TR_CONFIG_WAREHOUSES_GRANARIES_OVER_ROAD_PLACEMENT, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_WAREHOUSES_GRANARIES_OVER_ROAD_PLACEMENT_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_GP_CH_ROAMERS_DONT_SKIP_CORNERS, TR_CONFIG_ROAMERS_DONT_SKIP_CORNERS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_ROAMERS_DONT_SKIP_CORNERS_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_GP_CH_TOWER_SENTRIES_GO_OFFROAD, TR_CONFIG_TOWER_SENTRIES_GO_OFFROAD, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_TOWER_SENTRIES_GO_OFFROAD_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_GP_CARAVANS_MOVE_OFF_ROAD, TR_CONFIG_CARAVANS_MOVE_OFF_ROAD, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_CARAVANS_MOVE_OFF_ROAD_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_GP_CH_GETTING_GRANARIES_GO_OFFROAD, TR_CONFIG_GETTING_GRANARIES_GO_OFFROAD, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_GETTING_GRANARIES_GO_OFFROAD_TOOLTIP},
        {TYPE_NONE}
    },
    // Roadblock
    {
        {TYPE_CHECKBOX, CONFIG_GP_CH_GATES_DEFAULT_TO_PASS_ALL_WALKERS, TR_CONFIG_GATES_DEFAULT_TO_PASS_ALL_WALKERS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_GATES_DEFAULT_TO_PASS_ALL_WALKERS_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_GP_CH_GRANARY_DEFAULT_TO_PASS_ALL_WALKERS, TR_CONFIG_GRANARY_DEFAULT_TO_PASS_ALL_WALKERS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_GRANARY_DEFAULT_TO_PASS_ALL_WALKERS_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_GP_CH_WAREHOUSE_DEFAULT_TO_PASS_ALL_WALKERS, TR_CONFIG_WAREHOUSE_DEFAULT_TO_PASS_ALL_WALKERS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_WAREHOUSE_DEFAULT_TO_PASS_ALL_WALKERS_TOOLTIP},
        {TYPE_NONE}
    },
    // Housing
    {
        {TYPE_CHECKBOX, CONFIG_GP_CH_ALL_HOUSES_MERGE, TR_CONFIG_ALL_HOUSES_MERGE, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_ALL_HOUSES_MERGE_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_GP_CH_PATRICIAN_DEVOLUTION_FIX, TR_CONFIG_PATRICIAN_DEVOLUTION_FIX, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_PATRICIAN_DEVOLUTION_FIX_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_GP_CH_HOUSES_DONT_EXPAND_INTO_GARDENS, TR_CONFIG_HOUSES_DONT_EXPAND_INTO_GARDENS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_HOUSES_DONT_EXPAND_INTO_GARDENS_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_GP_CH_HOUSING_PRE_MERGE_VACANT_LOTS, TR_CONFIG_GP_CH_HOUSING_PRE_MERGE_VACANT_LOTS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_GP_CH_HOUSING_PRE_MERGE_VACANT_LOTS_TOOLTIP},
    ...
    // Destruction
    {
        {TYPE_CHECKBOX, CONFIG_GP_CH_ALWAYS_DESTROY_BRIDGES, TR_CONFIG_GP_CH_ALWAYS_DESTROY_BRIDGES, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_GP_CH_ALWAYS_DESTROY_BRIDGES_TOOLTIP},
        {TYPE_CHECKBOX, CONFIG_GP_CH_AUTO_CLEAR_TREES, TR_CONFIG_GP_CH_AUTO_CLEAR_TREES, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN, TR_CONFIG_GP_CH_AUTO_CLEAR_TREES_TOOLTIP},
    }
};
...
{
    if (m->x >= x && m->x < x + avail_text_w &&
        m->y >= y && m->y < y + ITEM_BASE_H) {
        *focused = 1;
    }
    return 0;
}
...
static void get_tooltip(tooltip_context *c)
{
    ...
    /* Tooltip for options */
    if (data.focus_button > 0 && data.focus_button <= data.layout.visible_to - data.layout.visible_from) {
        const config_widget *w = data.layout.rows[data.focus_button - 1];
        if (w && w->tooltip) {
            c->translation_key = w->tooltip;
            c->type = TOOLTIP_BUTTON;
            return;
        }
    }
