...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_GETTING_GRANARIES_GO_OFFROAD_TOOLTIP, "- Allows cart pushers from granaries set to \"Get\" to leave roads when collecting food from granaries set to \"Accept\".\n - Removes the need for a road connection between \"Get\" and \"Accept\" granaries.\n - As with warehouses, they always collect from the nearest \"Accept\" granary and ignore other \"Get\" granaries."},
    ...
    {TR_CONFIG_ALLOW_EXPORTING_FROM_GRANARIES_TOOLTIP, "By default, food imports, exports and Caesar requests only work with food stored in warehouses. Augustus also allows imports and requests directly from granaries. Because exporting food from granaries may cause starvation, this option is disabled by default."},
